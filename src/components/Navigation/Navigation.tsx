        ...
        <>
                        ...
                        <div className="hidden md:block">
                            <nav aria-label="Site Nav">
                                <ul className="flex items-center gap-6 text-sm">
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to="/">
                                            Главная
                                        </Link>
                                    </li>
                                    <li className='flex items-center cursor-pointer text-white'
                                        onClick={subMenuActiveHandler}>Услуги ▽
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/catalog'>
                                            Каталог
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/gallery'>
                                            Галлерея
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/elitegallery'>
                                            Галлерея VIP
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/locks'>
                                            Замки
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/about'>
                                            О нас
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" to='/contacts'>
                                            Контакты
                                        </Link>
                                    </li>
                                </ul>
            ...
            <nav className={cn('container mx-auto ' + styles.subMenuBody, subMenuActive ? styles.active : '')}>
                <ul className={cn(styles.subMenuList, subMenuActive ? styles.active : '')}>
                    ...
                    <li><Link to='/price'>Видео-инструкция</Link></li>
                    {/* ??? не уверен в надобности данной страницы*/}
                </ul>
            </nav>
            {/*  ============= subMenu =========== */}
        </>
